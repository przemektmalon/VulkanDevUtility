...
public:
  ...
  void
  cmdSet(CommandBuffer *cmd,
         VkPipelineStageFlagBits stage = VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT);
  void cmdReset(CommandBuffer *cmd, VkPipelineStageFlagBits stage =
                                        VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT);
  void
  cmdSet(VkCommandBuffer &cmd,
         VkPipelineStageFlagBits stage = VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT);
  void cmdReset(VkCommandBuffer &cmd, VkPipelineStageFlagBits stage =
                                          VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT);
  void set();
  void reset();
